...
const lunchMenus = [
  ...
  { name: '마라탕', note: '민지에게 얼얼하고 따뜻한 기운이 필요한 날 잘 어울려.' },
  { name: '김치볶음밥', note: '익숙하고 든든한 맛으로 민지의 오후를 힘 있게 채워줄 거야.' },
  { name: '오므라이스', note: '노란 계란 이불처럼 민지의 점심을 포근하게 덮어줄 메뉴야.' },
  { name: '치즈 라볶이', note: '매콤한 떡볶이에 치즈가 녹아서 민지 기분까지 부드러워질 거야.' },
  { name: '소금빵 샌드위치', note: '짭짤하고 고소해서 민지의 점심 산책 같은 맛이야.' },
  { name: '바질 토마토 파스타', note: '향긋하고 산뜻해서 민지에게 기분 좋은 리셋이 되어줄 거야.' },
  { name: '불고기 덮밥', note: '달달한 불고기가 민지의 배도 마음도 든든하게 채워줄 거야.' },
  { name: '새우 크림 리조또', note: '몽글몽글한 크림 맛이 민지의 점심을 다정하게 만들어줄 거야.' },
  { name: '닭갈비 볶음밥', note: '매콤하고 고소해서 민지의 오후 집중력을 깨워줄 메뉴야.' },
  { name: '딸기 생크림 샌드', note: '달콤한 딸기와 크림이 민지에게 작은 생일 기분을 줄 거야.' },
  { name: '말차 티라미수와 샐러드', note: '달콤쌉싸름한 조합이 민지의 점심을 특별하게 만들어줄 거야.' },
  { name: '치킨마요 덮밥', note: '달콤짭짤하고 든든해서 민지가 편하게 고르기 좋은 메뉴야.' },
  { name: '쌀국수', note: '따뜻한 국물이 민지의 속을 편안하게 안아줄 점심이야.' },
  { name: '브리오슈 프렌치토스트', note: '폭신하고 달콤해서 민지의 하루에 부드러운 쉼표가 될 거야.' }
];
